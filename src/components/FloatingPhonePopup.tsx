                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <a href="tel:+919346672015" className="text-foreground tracking-wide font-semibold hover:text-accent transition-colors block mb-2">
                                +91 9346672015
                            </a>
                            <div className="h-px bg-border w-full my-2" />
                            <p className="text-sm text-muted font-medium mb-1">WhatsApp Us</p>
                            <a 
