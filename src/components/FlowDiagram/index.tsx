...
export default function FlowDiagram() {
    ...
    const resetView = useCallback(() => {
        ...
        setSelectedNode(null)
        // Center the view after resetting
        setTimeout(() => {
        ...
        <section className="relative py-24 px-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="relative h-[500px] rounded-2xl glass-card overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 flex flex-col bg-card border border-border rounded-lg overflow-hidden z-10">
                        <button
                            onClick={handleZoomIn}
                            className="w-10 h-10 flex items-center justify-center hover:bg-card-hover transition-colors text-foreground font-bold text-lg"
                            title="Zoom In"
                        >
                            +
                        </button>
